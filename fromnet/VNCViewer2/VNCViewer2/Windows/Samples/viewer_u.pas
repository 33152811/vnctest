...
uses
  ...
  Dialogs, VNCViewer, Menus, AppEvnts, ExtCtrls;

const
  tsFlag=SWP_DRAWFRAME or SWP_FRAMECHANGED or SWP_NOZORDER;
...
begin
  MessageBox(handle,pchar('Delphi VNC Viewer Control version 1.2'+#13#10+'Magic Pot Shareware'),'System',MB_ICONINFORMATION+MB_OK);
end;
