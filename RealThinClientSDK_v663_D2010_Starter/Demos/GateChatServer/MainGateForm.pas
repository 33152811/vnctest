...
{ This example demonstrates how to set up and use a TRtcGateway component with a TRtcHttpServer.
  ...
  Additionally, this "ChatServer" example will accept ONLY connections from the "ChatClient"
  ...
  all Chat Clients as Hosts and Listeners to the "Chat" channel with GroupID 254.
...
procedure TGateForm.GateUserReady(Sender: TRtcConnection; UserID: Cardinal; const UserAuth: String);
  ...
  if UserAuth='MyChatClient' then
    Gate.AddUserToChannel(UserID,'Chat',254,True,True,0,True,False);
  end;
