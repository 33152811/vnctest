object GateClientForm: TGateClientForm
  ...
  object GateCli: TRtcHttpGateClient
    ...
    UseProxy = True
    StreamBlockSizeIn = 4
    StreamBlockSizeOut = 4
    AccountManager = AccMan
    BeforeLogIn = ClientBeforeLogIN
    AfterLogIn = ClientAfterLogIN
    AfterLoginFail = ClientAfterLoginFail
    AfterLogOut = ClientAfterLogOUT
    OnDataReceived = ClientDataReceived
    OnInfoReceived = ClientInfoReceived
    OnReadyToSend = ClientReadyToSend
    OnStreamReset = ClientStreamReset
    Left = 160
    Top = 68
  end
  object ChatLink: TRtcGateClientLink
    Client = GateCli
    OnDataReceived = ChatLinkDataReceived
    Left = 96
    Top = 68
  end
