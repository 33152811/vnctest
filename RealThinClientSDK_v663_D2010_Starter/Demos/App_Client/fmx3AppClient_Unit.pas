...
uses
  ...
  FMX.Edit, FMX.TabControl, FMX.Objects, FMX.StdCtrls,

{$IF Defined(StreamSecII)}
  rtcSSecTest,
{$IFEND}

  rtcFMX.GUI, // handle Thread.Synchronize() using a FMX Timer.

  rtcLog, rtcSyncObjs,
  rtcFunction, rtcDataCli,
  rtcCliModule, rtcInfo, rtcConn,
  rtcHttpCli, rtcThrPool, rtcPlugins, FMX.Controls.Presentation;
